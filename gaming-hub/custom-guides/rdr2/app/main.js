...
const STORY_CHAPTERS = [
  ...
  },
  {
    ...
    missions: [
      createDetailedMission("wheel", "The Wheel", [
        ["Briefing", "Travel to Pronghorn Ranch and complete the arrival sequence as John Milton."],
        ["Orientation", "Follow ranch instructions and stay in formation during the opening work beats."],
        ["Labor", "Complete the assigned chores without wandering away from the job area."],
        ["Finish", "Close the shift and settle into the ranch routine."],
      ]),
      createDetailedMission("simple-pleasures", "Simple Pleasures", [
        ["Briefing", "Take the ranch assignment and start the delivery route."],
        ["Work", "Finish each chore or delivery prompt in sequence and keep the route clean."],
        ["Trouble", "Respond to local interference without abandoning the mission path."],
        ["Finish", "Return to the ranch and complete the workday wrap-up."],
      ]),
      createDetailedMission("farming-beginners", "Farming, for Beginners", [
        ["Briefing", "Learn the ranch routine and begin the daily task loop."],
        ["Farm Work", "Complete the assigned farming steps and stay with the tutorial prompts."],
        ["Interruption", "Handle hired-man disruption by keeping the objectives active."],
        ["Finish", "Close the shift and return to the ranch owner."],
      ]),
      createDetailedMission("fatherhood-beginners", "Fatherhood, for Beginners", [
        ["Briefing", "Ride with Jack and trigger the hunting outing sequence."],
        ["Outing", "Follow the route and complete the hunting objective prompts."],
        ["Wolf Attack", "Protect Jack during the ambush and keep the path clear."],
        ["Finish", "Return Jack home and complete the family beat."],
      ]),
      createDetailedMission("old-habits", "Old Habits", [
        ["Briefing", "Meet the old contact and recover the bounty lead."],
        ["Track", "Follow the trail and close in on the target without losing the search."],
        ["Capture", "Take the target alive if possible and avoid a messy collapse."],
        ["Finish", "Turn in the bounty and close the mission payout scene."],
      ]),
      createDetailedMission("jim-milton-rides", "Jim Milton Rides, Again?", [
        ["Briefing", "Join Sadie and start the bounty run from the ranch."],
        ["Pursuit", "Engage enemies or target gang members as the objective requires."],
        ["Control", "Keep the target contained and prevent escape lines from opening."],
        ["Finish", "Deliver the target and complete the mission wrap-up."],
      ]),
      createDetailedMission("motherhood", "Motherhood", [
        ["Briefing", "Reunite the family and begin the Beecher's Hope move."],
        ["Transition", "Handle the moving sequence and keep the family together."],
        ["Settlement", "Complete the arrival objectives and establish the new home state."],
        ["Finish", "Close the relocation and return to the ranch story arc."],
      ]),
      createDetailedMission("gainful-employment", "Gainful Employment", [
        ["Briefing", "Take the ranch job and start the supply loop."],
        ["Labor", "Complete the work prompts and remain inside the assigned area."],
        ["Disruption", "Handle anything that interrupts the job without dropping the objective."],
        ["Finish", "Return home and conclude the workday mission."],
      ]),
      createDetailedMission("tool-box", "The Tool Box", [
        ["Briefing", "Meet Uncle and Charles and prepare for the construction run."],
        ["Gather", "Collect lumber and supplies from the marked locations."],
        ["Delivery", "Transport materials back to the build site safely."],
        ["Finish", "Complete the construction prep sequence."],
      ]),
    ],
  },
  {
    ...
    missions: [
      createDetailedMission("new-jerusalem", "A New Jerusalem", [
        ["Briefing", "Begin the final house-building work and move with the crew to the frame site."],
        ["Construction", "Complete each hammering/build prompt in the order shown."],
        ["Coordination", "Keep pace with the team and avoid walking away from the build area."],
        ["Finish", "Complete the milestone scene and lock the home-building progress."],
      ]),
      createDetailedMission("honest-days-labors", "An Honest Day's Labors", [
        ["Briefing", "Ride with Sadie and start the bounty lead sequence."],
        ["Tracking", "Follow the target trail through the mission route."],
        ["Capture", "Take the target alive or clear resistance depending on the prompt."],
        ["Finish", "Return and close the bounty payout."],
      ]),
      createDetailedMission("landowning-classes", "The Landowning Classes", [
        ["Briefing", "Confront the ranch dispute and move into the property conflict area."],
        ["Gunfight", "Win the firefight and keep the property objective from failing."],
        ["Control", "Secure the area after the clash and handle the aftermath beats."],
        ["Finish", "Return to settle the property aftermath."],
      ]),
      createDetailedMission("uncle-bad-day", "Uncle's Bad Day", [
        ["Briefing", "Track Uncle's kidnapping lead and move to the hideout route."],
        ["Raid", "Fight into the hideout and keep moving until Uncle is found."],
        ["Rescue", "Free Uncle and protect the escape lane."],
        ["Finish", "Bring him back to Beecher's Hope and close the mission."],
      ]),
      createDetailedMission("home-improvement", "Home Improvement for Beginners", [
        ["Briefing", "Handle the house-financing and paperwork sequence."],
        ["Commerce", "Complete the required town interactions and legal prompts."],
        ["Settlement", "Lock in the ownership-related mission beats."],
        ["Finish", "Finalize the ownership milestone at Beecher's Hope."],
      ]),
      createDetailedMission("american-venom", "American Venom", [
        ["Briefing", "Join Sadie and Charles and start the hunt for Micah."],
        ["Climb", "Fight through the mountain approach while staying with the team."],
        ["Defense", "Break through the defenses and keep moving toward the finale."],
        ["Confrontation", "Complete the final fight and resolve the story ending."],
        ["Finish", "Confirm the final mission clears and the epilogue closes."],
      ]),
    ],
  },
];
